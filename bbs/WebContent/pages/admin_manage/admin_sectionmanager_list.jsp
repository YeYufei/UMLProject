...
<html>
<head>
<title>后台管理_版主列表</title>
<link rel="stylesheet" type="text/css" href="css/admin_manage/admin_user_list.css">
<meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
<script type="text/javascript" src="js/admin_manage/admin_sectionmanager_list.js"></script>
</head>
<body>
<div style="width: 100%;height: 100%">
	<table style="width: 90%;font-size: 15px;margin:20px; font-weight: bolder">
		<tr>
			<td>
				<img src="images/user_list.png">&nbsp;&nbsp;版主列表
				&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
	...
	<c:choose>
		<c:when test="${users.totalCount=='0'}">
			<table style="width: 90%;margin:20px;">
				<tr>
					<td>
						<font style="font-size: 13px;color: red;">暂无任何版主</font>
					</td>
				</tr>
			</table>
		</c:when>
		...
		<c:set value="1" var="i"/>
			<c:forEach var="userVO" items="${users.items}">
					<tr style="color: #FF8C00">
						...
						<td align="left">${userVO.sectionName}</td>
						<td style="text-align: center;width: 200px">
						<img alt="查看版主详细信息" src="images/view_note.gif">
						<a href="admin/user-viewUser?userVO.id=${userVO.id}&currentPage=${pageInfo.currentPage}" onclick="showMask();">查看</a>
						<img alt="解除版主身份" src="images/delete_manager.png">
						<a href="javaScript:void(0);" onclick="deleteSectionManager(${userVO.id},${pageInfo.currentPage});" onclick="showMask();">解除版主</a>
						</td>
					</tr>
			...
			<table style="width: 90%;margin:20px;font-size: 12px;color: blue">
				<tr>
					...
					<c:when test="${pageInfo.currentPage!=1}">
						<img onclick="window.location.href='admin/user-queryAllSectionManager?currentPage=1'" src="images/resultset_first.png" alt="第一页" style="cursor: pointer;"/>
						<img onclick="window.location.href='admin/user-queryAllSectionManager?currentPage=${pageInfo.currentPage-1}'" src="images/resultset_previous.png" alt="上一页" style="cursor: pointer;"/>
					</c:when>
					</c:choose>
					 第${pageInfo.currentPage}页
					 <c:choose>
						 <c:when test="${pageInfo.currentPage!=pageInfo.allPages}">
							<img onclick="window.location.href='admin/user-queryAllSectionManager?currentPage=${pageInfo.currentPage+1}'" src="images/resultset_next.png" alt="下一页" style="cursor: pointer;"/>
						 	<img onclick="window.location.href='admin/user-queryAllSectionManager?currentPage=${pageInfo.allPages}'" src="images/resultset_last.png" alt="最后一页" style="cursor: pointer;"/>
						 </c:when>
					 </c:choose>
					</td>
				</tr>
