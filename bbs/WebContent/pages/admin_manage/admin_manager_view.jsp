...
<div style="width: 100%;height: 100%">
	<table style="width: 90%;font-size: 15px;margin:20px; font-weight: bolder">
		<tr>
			<th>
				<img src="images/user_list.png">&nbsp;&nbsp;管理员查看
				&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
			</th>
		</tr>
	</table>
			...
			<td valign="top">
				...
				<c:choose>
					<c:when test="${userVO.userInfoVO.image==''}">
						<c:choose>
							<c:when test="${userVO.userInfoVO.sex=='男'}">
								<img alt="管理员照片" src="images/system_image/default_image_boy.gif" width="120" height="120">
							</c:when>
							<c:otherwise>
								<img alt="管理员照片" src="images/system_image/default_image_girl.gif" width="120" height="120">
							</c:otherwise>
						</c:choose>
					</c:when>
					<c:otherwise>
						<img alt="管理员照片" src="${userVO.userInfoVO.image}" width="120" height="120">
					</c:otherwise>
				</c:choose>
			</td>
			<td>
