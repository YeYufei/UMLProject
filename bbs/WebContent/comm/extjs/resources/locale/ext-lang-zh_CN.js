...
l_usernameEmpty = '请输入用户名';
l_userpwdEmpty = '请输入密码';
l_validateEmpty='请输入验证码';
l_usernameMinLengthText = '用户名不应该少于3个字符';
l_usernameMaxLengthText = '用户名不应该超过20字符';
l_passwordMinLengthText = '密码不应该少于6个字符'
l_passwordMaxLengthText = '密码不应该超过20个字符'
