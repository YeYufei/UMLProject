...
g_l.YEAR_BCK = "上一年";
g_l.CLOSE = "关闭";
g_l.ERROR_2 = g_l.ERROR_1 = "无效的日期";
g_l.ERROR_4 = g_l.ERROR_3 = "没有组件";
...
JsDatePick.prototype.setConfiguration = function(a) {
	this.oConfiguration.isStripped = (a.isStripped != null)
			? a.isStripped
			: false;
	this.oConfiguration.useMode = (a.useMode != null) ? a.useMode : 1;
	this.oConfiguration.selectedDate = (a.selectedDate != null)
			? a.selectedDate
			: null;
	this.oConfiguration.target = (a.target != null) ? a.target : null;
	this.oConfiguration.yearsRange = (a.yearsRange != null) ? a.yearsRange : [
			1971, 2100];
	this.oConfiguration.limitToToday = (a.limitToToday != null)
			? a.limitToToday
			: false;
	this.oConfiguration.field = (a.field != null) ? a.field : false;
	this.oConfiguration.cellColorScheme = (a.cellColorScheme != null)
			? a.cellColorScheme
			: "ocean_blue";
	this.oConfiguration.dateFormat = (a.dateFormat != null)
			? a.dateFormat
			: "%m-%d-%Y";
	this.oConfiguration.imgPath = (g_jsDatePickImagePath.length != null)
			? g_jsDatePickImagePath
			: "img/";
	this.oConfiguration.weekStartDay = (a.weekStartDay != null)
			? a.weekStartDay
			: 1;
	...
	if (this.oConfiguration.useMode == 2) {
		if (this.oConfiguration.target != false) {
			if (typeof(JsgetElem(this.oConfiguration.target)) != null) {
				...
				n.onclick = function() {
					JsDatePick.getCalInstanceById(this
							.getAttribute("globalNumber")).showCalendar()
				};
...
JsDatePick.prototype.getSelectedDayFormatted = function() {
	if (this.flag_aDayWasSelected) {
		...
		if(g_l.MONTHS[this.selectedDayObject.month - 1]<10){
			a = a.replace("%M", '0'+g_l.MONTHS[this.selectedDayObject.month - 1]);
		}else{
